...
def zadanie6(data):
    ...
    print(
        f"Najwyższa dodatnia korelacja: {highest_positive_corr} między kolumnami {pos_pair}"
    )
    print(
        f"Najwyższa ujemna korelacja: {highest_negative_corr} między kolumnami {neg_pair}"
    )
